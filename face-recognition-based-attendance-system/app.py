...
# Extract info from today's attedance file in attendance folder
...
# Add Attendance of a spesific user
...
# Our main Recognition functionality
# This function will run when we click to Take Attendance Button
